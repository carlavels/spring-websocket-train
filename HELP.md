...
* The original package name 'com.carlavels.train.spring-websocket-train' is invalid and this project uses 'com.carlavels.train.spring_websocket_train' instead.
...
* [WebSocket](https://docs.spring.io/spring-boot/docs/3.2.9/reference/htmlsingle/index.html#messaging.websockets)
